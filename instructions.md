...
Change the colors of each of the newly added lines by giving the ```borderColor``` keys new hexidecimal color values. You can use any colors you choose, or use these: `#8e5ea2`'puprle', `#3cba9f`'teal', `#e8c3b9`'orange', `#c45850 `'rust orange', `#ff8c00`. Your final graph should look something like this, with built-in tool-tip functionality and responsiveness that you can check by adjusting the size of your web browser.
